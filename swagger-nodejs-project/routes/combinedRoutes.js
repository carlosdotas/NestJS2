...
const combinedRoutes = [
  { path: '/users', method: 'get', action: userActions.fetchUsers },
  { path: '/users', method: 'post', action: userActions.createUser },
  { path: '/users/:id', method: 'get', action: userActions.fetchUserById },
  { path: '/users/:id', method: 'put', action: userActions.updateUser },
  { path: '/users/:id', method: 'delete', action: userActions.deleteUser },
  { path: '/products', method: 'get', action: productActions.fetchProducts },
  { path: '/products', method: 'post', action: productActions.createProduct },
  { path: '/products/:id', method: 'get', action: productActions.fetchProductById },
  { path: '/products/:id', method: 'put', action: productActions.updateProduct },
  { path: '/products/:id', method: 'delete', action: productActions.deleteProduct },
];
